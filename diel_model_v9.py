...
Usage:
    python diel_model_v9.py                  # uses defaults
    python diel_model_v9.py path/to/data.csv # custom CSV
"""
...
OUTPUT_DIR    = 'output\\summer\\output_v9'
